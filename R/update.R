...
update <- function(){
  ...
  testmode <- TRUE # boolean, testmode = FALSE bedeutet, dass die Files auf das Produktive MDV geladen werden
  ...
  zhapir::update_distribution(id = ressourcen_id_rohdaten,
                              ...
                              zh_web_flag = TRUE, # auf zh.ch/opendata
                              stat_server_flag = TRUE,
                              status_id = 3, # ACHTUNG: Um direkt zu publizieren, muss status=3 gesetzt werden
                              license_id = 2,
                              use_dev = FALSE)
                              # api_key = "xxx")
  ...
  zhapir::update_distribution(id = ressourcen_id_aufbereitete_daten,
